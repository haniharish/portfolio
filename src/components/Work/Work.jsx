  ...
  return (
    ...
    >
      <div className="text-center mb-16">
        <h2 className="text-4xl font-bold text-text dark:text-white">PROJECTS</h2>
        <div className="w-32 h-1 bg-accent mx-auto mt-4"></div>
        <p className="text-muted dark:text-gray-300 mt-4 text-lg font-semibold">
          Selected projects that showcase my experience with MERN stack, secure authentication,
      ...
      <div className="grid gap-12 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        {projects.map((project) => (
          <div
            ...
            className="border border-border dark:border-white/10 bg-card dark:bg-gray-900 backdrop-blur-md rounded-2xl shadow-[0_18px_45px_rgba(15,23,42,0.08)] dark:shadow-2xl overflow-hidden cursor-pointer hover:shadow-accent/30 hover:-translate-y-2 transition-transform duration-300"
          >
            <div className="p-4">
              <img
                src={project.image}
            ...
            <div className="p-6">
              ...
              <p className="text-muted dark:text-gray-400 mb-4 pt-4 line-clamp-3">
                {project.description}
              </p>
              <div className="mb-4">
                {project.tags.map((tag, index) => (
                  <span
                    key={index}
                    className="inline-block bg-indigo-50 dark:bg-[#251f38] text-xs font-semibold text-accent rounded-full px-2 py-1 mr-2 mb-2"
                  >
                    {tag}
                  </span>
                ))}
          ...
          <div className="bg-card dark:bg-gray-900 rounded-xl shadow-2xl lg:w-full w-[90%] max-w-3xl overflow-hidden relative">
            ...
            <div className="flex flex-col">
              ...
              <div className="lg:p-8 p-6">
                <h3 className="lg:text-3xl font-bold text-text dark:text-white mb-4 text-md">
